...
"""autogenerated by genpy from uav_simulator/LivoxCustomMsg.msg. Do not edit."""
import codecs
import sys
...
import std_msgs.msg
import uav_simulator.msg

class LivoxCustomMsg(genpy.Message):
  _md5sum = "e4d6829bdfe657cb6c21a746c86b21a6"
  _type = "uav_simulator/LivoxCustomMsg"
...
"""
  ...
  _slot_types = ['std_msgs/Header','uint64','uint32','uint8','uint8[3]','uav_simulator/CustomPoint[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LivoxCustomMsg, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = uav_simulator.msg.CustomPoint()
        _x = val1
        start = end
        end += 19
