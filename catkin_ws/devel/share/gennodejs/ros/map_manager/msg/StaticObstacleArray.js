...
class StaticObstacleArray {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.obstacles.forEach((val) => {
      bufferOffset = StaticObstacle.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new StaticObstacleArray(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.obstacles[i] = StaticObstacle.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.obstacles.forEach((val) => {
      length += StaticObstacle.getMessageSize(val);
    });
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new StaticObstacleArray(null);
    ...
    if (msg.obstacles !== undefined) {
      ...
      for (let i = 0; i < resolved.obstacles.length; ++i) {
        resolved.obstacles[i] = StaticObstacle.Resolve(msg.obstacles[i]);
      }
    }
    else {
      resolved.obstacles = []
...
module.exports = StaticObstacleArray;
