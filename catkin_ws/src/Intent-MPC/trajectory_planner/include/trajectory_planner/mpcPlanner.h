...
namespace trajPlanner{
	...
	private:
		...
		ros::ServiceClient staticObstacleClient_;
		bool useStaticDetector_;
		double ts_; // timestep
		...
		std::vector<staticObstacle> lastStaticObstacles_;  // 缓存静态障碍物数据
	...
	public:
		...
		std::vector<staticObstacle> getStaticObstaclesFromDetector();
